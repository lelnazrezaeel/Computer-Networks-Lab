...
def run():
    ...
    info('\n** Adding Hosts\n')
    h1 = net.addHost('h1', ip='65.81.1.1/24', hostname='h1',  privateLogDir=True, privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    h2 = net.addHost('h2', ip='65.81.1.2/24', hostname='h2',  privateLogDir=True, privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    h3 = net.addHost('h3', ip='65.81.10.3/24', hostname='h3',  privateLogDir=True, privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    h4 = net.addHost('h4', ip='65.81.10.4/24', hostname='h4',  privateLogDir=True, privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    r1 = net.addHost('r1', ip='65.81.1.5/24', hostname='r1',  privateLogDir=True, privateRunDir=True, inMountNamespace=True, inPIDNamespace=True, inUTSNamespace=True)
    ...
    r1.cmd('ifconfig r1-eth1 65.81.10.5 netmask 255.255.255.0')
    r1.cmd('echo 1 > /proc/sys/net/ipv4/ip_forward')
    h1.cmd('ip route add default via 65.81.1.5')
    h2.cmd('ip route add default via 65.81.1.5')
    h3.cmd('ip route add default via 65.81.10.5')
    h4.cmd('ip route add default via 65.81.10.5')
    
    r1.cmd('iptables -t nat -A PREROUTING -p ICMP -s 65.81.10.3 -d 65.81.10.5 -j DNAT --to 65.81.1.1')
    r1.cmd('iptables -t nat -A POSTROUTING -p ICMP -s 65.81.1.1 -d 65.81.10.3 -j SNAT --to 65.81.10.5')
