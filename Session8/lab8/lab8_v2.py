...
def run():
    ...
    info('** Creating an instance of Lab 8 network topology\n')
    topo = LabTopo()
    ...
    info('** Starting the Quagga Service on Virtual Routers\n')
    for r in hosts:
	if r.name not in ['h1','h2']:
		r.cmd( "echo 1 > /proc/sys/net/ipv4/ip_forward" )
		r.cmd("/etc/init.d/quagga start")
