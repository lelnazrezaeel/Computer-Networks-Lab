...
class LabTopo(Topo):
    ...
    "Creates Lab Topology"

    def __init__(self):
        """Initialize a Quagga topology with 2 hosts, 5 routers, 7 switches, quagga service, in a topology"""
        Topo.__init__(self)
        ...
        # We require a "configs" folder in the same path of the lab8_topo file, and within
        # the configs folder, we require one folder for each host, named as the host itself.
        ...
        # We add links between switches and routers 
        info( '*** Creating links\n' )
